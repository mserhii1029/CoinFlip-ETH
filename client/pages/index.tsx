  ...
  return (
    <>
      ...
      <div className='text-center mb-5'>
        ...
        <h2 className='text-xl mb-4'>by Serhii Muzyka</h2>
        {!contract && (
          <div className='p-clamp mx-auto'>
            ...
            <br />
            <p>
              If you're using Rinkeby, you will need some test Ether which you can get at a faucet.
              <br />
              <a className='text-blue-400 underline' href='https://faucet.rinkeby.io/' target='_blank'>
